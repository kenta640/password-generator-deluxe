  ...
  return (
    <section className="p-6 border rounded-lg bg-slate-50">
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-lg font-semibold">パスワード生成</h2>
      ...
      <div className="mb-4 flex gap-2">
        <button onClick={handleGenerate} className="px-4 py-2 bg-slate-800 text-white rounded">生成</button>
        <button onClick={handleCopy} className="px-3 py-2 border rounded flex items-center gap-2"><Copy size={16} /> コピー</button>
      </div>
